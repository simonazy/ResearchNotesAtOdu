...
from art.attacks.evasion import PixelAttack, SpatialTransformation, HopSkipJump, NewtonFool, VirtualAdversarialMethod, ElasticNet, DeepFool, BasicIterativeMethod, BoundaryAttack,FastGradientMethod,AdversarialPatch
...
def load_patch(classifier):
    return AdversarialPatch(classifier=classifier,
                            max_iter = 20, 
                            rotation_max = 60.0,
                            scale_min = 0.1,
                            scale_max = 0.2
...
if __name__ == '__main__':
    load_model('/home/jasmine/myLBC/ckpts/image')
